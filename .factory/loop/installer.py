...
PENDING_ALLOWLIST: frozenset = frozenset({
    ...
    '.factory/production-graphics-approval.json',
    '.factory/human-review-trust.json',
    ...
    '.factory/schemas/factory-readiness-result-v3.schema.json',
    '.factory/schemas/factory-readiness-findings-v1.schema.json',
    '.factory/schemas/factory-readiness-findings-consumed-v1.schema.json',
