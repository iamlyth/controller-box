...
GEN=ROOT/'.factory/runner/generate-runner-install-manifest.py'
required=(
 '.factory/runner/install-factory-runner-v2.sh','.factory/runner/factory-runner-root-bootstrap',
 '.factory/runner/factory-runner-broker.py','.factory/runner/factory-runner-signer.py',
 '.factory/runner/factory-runner-server.py','.factory/runner/factory_runner_policy.py',
 '.factory/runner/factory_runner_artifacts.py','.factory/runner/factory_runner_authority.py',
 '.factory/runner/build-runner-probe-authority.py','deploy/factory-runner-authority-v1/authority.json')
