...
# (.factory/tools/pi-factory-guard-extension.mjs) and its tracked sibling guard
# (.factory/tools/credential-guard.py). Only fake secrets are used: every value is a
