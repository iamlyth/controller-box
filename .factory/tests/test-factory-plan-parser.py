...
class CanonicalPlanAgreementTest(unittest.TestCase):
    ...
    def test_canonical_plan_parses(self) -> None:
        ...
        self.assertEqual(len(plan.tasks), 42)
        ...
        self.assertEqual(final[0].number, 42)
        self.assertEqual(set(final[0].dependencies), set(range(1, 42)))
        # Default priority derives from the task id for a stable sort; the
        # appended factory tasks 34/37-41 carry explicit priority 1.
        self.assertEqual(
