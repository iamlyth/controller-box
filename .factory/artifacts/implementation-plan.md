...
## Task 4: Final documentation and specification audit (deferred)
- Status: blocked
...
## Task 38: Final documentation and specification audit
- Status: blocked
- Blocked on: Task 36 and FACT-006 — the evidence publication/verifier gap must be closed, and the current production change leaves three `test_golden` editor comparisons failing because the baselines encode the prior diagram. The golden policy requires out-of-band human review/approval; automated framebuffer evidence and a passing semantic installed test cannot resolve this human release decision.
- Dependencies: Task 1, Task 2, Task 3, Task 4, Task 5, Task 6, Task 7, Task 8, Task 9, Task 10, Task 11, Task 12, Task 13, Task 14, Task 15, Task 16, Task 17, Task 18, Task 19, Task 20, Task 21, Task 22, Task 23, Task 24, Task 25, Task 26, Task 27, Task 28, Task 29, Task 30, Task 31, Task 32, Task 33, Task 34, Task 35, Task 36, Task 37
- Source: Task 33 evidence and the current verification result: `ctest` has the three editor-golden failures while installed semantic diagram checks pass. Task 34's verifier/evidence publication finding remains pending and is carried by Tasks 35 and 36. Task 37 carries the receipt-bound AUD-02 deterministic-selector finding and must be independently evidenced before this final audit can pass. This is intentionally not treated as a harmless pre-existing failure for completion.
- Scope: Final definition of done reconciliation of the conformance matrix, interaction inventory, open findings, facts ledger, documentation, and clean tree, including human review of representative BUG-0018 manager/profile-editor captures and the protected golden-policy workflow. Every unresolved capability or human requirement remains blocked; no rationale elevates evidence. If the golden review approves, update only the three reviewed baselines and rerun all gates; if rejected, append a bounded remediation task.
