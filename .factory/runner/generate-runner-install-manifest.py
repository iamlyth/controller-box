...
REQUIRED = {
    ".factory/runner/install-factory-runner-v2.sh",
    ".factory/runner/factory-runner-root-bootstrap",
    ".factory/runner/factory-runner-broker.py",
    ".factory/runner/factory-runner-signer.py",
    ".factory/runner/factory-runner-server.py",
    ".factory/runner/factory_runner_policy.py",
    ".factory/runner/factory_runner_artifacts.py",
    ".factory/runner/factory_runner_authority.py",
    ".factory/runner/build-runner-probe-authority.py",
...
def build(root: pathlib.Path, revision: str) -> dict:
    ...
    return {"schema": SCHEMA, "commit": commit, "tree": tree,
            ...
            "installer": ".factory/runner/install-factory-runner-v2.sh",
            "authority_builder": ".factory/runner/build-runner-probe-authority.py",
