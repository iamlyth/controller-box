...
canonical={
 ...
 '.factory/runner/gpurunner-probes/analyze-gpu-compositor.py':'gpurunner-probes/analyze-gpu-compositor.py',
 '.factory/runner/gpurunner-probes/egl_renderer_probe.c':'gpurunner-probes/egl_renderer_probe.c',
}
