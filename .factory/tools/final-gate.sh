...
case "$MODE" in
    --planning)
        ...
        if [[ -f .factory/artifacts/conformance.json ]]; then
            ./.factory/tools/validate-conformance.py planning .factory/artifacts/conformance.json "${CONFORMANCE_HUMAN_ARGS[@]}"
        fi
...
PY
        ...
        ./.factory/tools/validate-conformance.py complete .factory/artifacts/conformance.json "${CONFORMANCE_HUMAN_ARGS[@]}"
