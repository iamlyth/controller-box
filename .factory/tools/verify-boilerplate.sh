...
python3 .factory/tools/check-workspace-credentials.py --root "$PROJECT_ROOT"

mapfile -t SHELL_FILES < <(find scripts tests .factory/tools .factory/runner .factory/tests -type f -name '*.sh' -print | sort)
...
required = [
    ...
    '.factory/tools/factory-state-file.py',
    ...
    '.factory/tests/test-plan-cycle.sh',
    '.factory/tests/test-installed-functional-evidence.sh',
    '.factory/environment.toml', '.factory/artifacts/campaign-audit.md',
    '.factory/tools/check-factory-environment.py',
    '.factory/tools/initialize-campaign-audit.py',
    '.factory/tools/validate-campaign-audit.py', '.factory/tools/campaign-audit-scope-guard.sh',
    '.factory/verifier-acceptance.json',
    '.factory/runner/run-factory-runners.py', 'scripts/check-factory-runner-evidence.py',
    '.factory/runner/factory-runner-server.py', '.factory/runner/factory-runner-broker.py',
    '.factory/runner/factory_runner_authority.py', '.factory/runner/factory_runner_artifacts.py',
    '.factory/runner/build-runner-probe-authority.py', '.factory/runner/install-factory-runner-v2.sh',
    'scripts/archive-factory-campaign.py', '.factory/tools/check-workspace-credentials.py', '.factory/runner/validate-runner-artifacts-semantic.py',
    '.factory/runner/inputplumber-dbus-audit.py',
    ...
    '.factory/tests/test-factory-environment.sh', '.factory/tests/test-factory-runner.sh',
    '.factory/tests/test-runner-authority.py', '.factory/tests/test-runner-install-bootstrap.py',
    '.factory/tests/test-runner-installer-security.py', '.factory/tests/test-campaign-archive.py', '.factory/tests/test-workspace-credentials.py', 'tests/test-iprunner-probes.sh',
    '.factory/tests/test-broker-security.py', '.factory/tests/test-dbus-audit.py', '.factory/tests/test-campaign-residuals.py',
    'tests/test-gpu-compositor-probe.sh',
    '.factory/tests/test-campaign-audit.sh',
    '.factory/tests/test-legacy-factory-lock.py',
    '.factory/tests/test-orchestration-security.py',
    '.factory/tests/test-boilerplate-env-isolation.sh',
    '.factory/tests/test-production-path-bypass.sh',
    ...
    '.factory/tools/validate-conformance.py', '.factory/tools/check-capability-contracts.py',
    '.factory/tools/check-capability-evidence.py', '.factory/tools/machine-receipt.py',
    '.factory/tools/check-audit-receipts.py',
    '.factory/tools/validate-blocked-facts.py', '.factory/tools/check-campaign-objectives.py',
    ...
    '.factory/tools/visual-audit-provenance.py', '.factory/tools/visual-audit-lease.py',
    '.factory/tools/visual-audit-review.py', '.factory/tools/visual-audit-review-sdk.mjs',
    '.factory/tools/visual-audit-capture.sh', '.factory/tools/visual-audit-probe.sh',
    '.factory/tools/visual-capture-driver.sh', '.factory/tools/check-visual-audit.py',
    '.factory/tools/visual-audit-gate.sh', '.factory/tests/test-visual-audit.sh',
    '.factory/tools/nix-gate.sh', '.factory/tools/nix-gate-exec.sh',
    '.factory/tools/nix-gate-check.py', '.factory/tests/test-nix-gate.sh',
    '.factory/tools/credential-guard.py', '.factory/tests/test-credential-guard.sh',
    '.factory/tools/pi-factory-guard-extension.mjs',
    '.factory/tests/test-credential-extension.sh',
    ...
    '.factory/tests/test-conformance.sh', '.factory/tests/test-capability-contracts.sh',
    '.factory/tests/test-core-acceptance.sh', '.factory/tests/test-audit-receipts.sh',
    '.factory/tests/test-blocked-facts.sh', '.factory/tests/test-campaign-objectives.sh',
    '.factory/tests/test-golden-policy.sh',
    '.factory/tests/test-runner-signer.sh', '.factory/tools/check-spec-provided.sh',
    '.factory/tools/check-generic-leakage.sh', '.factory/generic-leak-allowlist',
...
for script in ('.factory/tools/final-gate.sh',):
...
# (.factory/tools/pi-factory-guard-extension.mjs) is the required replacement and
...
for script in .factory/tools/final-gate.sh \
        .factory/tools/campaign-verifier-binding.py \
        .factory/tools/check-installed-harness-evidence.sh \
        .factory/tools/visual-audit-provenance.py; do
    text=$(cat "$script")
...
grep -q '^const PRODUCTION_VISION_MODEL = "ollama/kimi-k2.6";$' .factory/tools/visual-audit-review-sdk.mjs
grep -q 'caller model override refused' .factory/tools/visual-audit-review-sdk.mjs
...
grep -q '.factory/tools/visual-audit-gate.sh' .factory/tools/final-gate.sh
grep -q 'check-visual-audit.py' .factory/tools/visual-audit-gate.sh
if grep -Eq 'visual-audit-(capture|probe)|review-sdk' .factory/tools/visual-audit-gate.sh; then
...
./.factory/tests/test-installed-functional-evidence.sh "$PROJECT_ROOT"
./.factory/tests/test-factory-environment.sh
./.factory/tests/test-factory-runner.sh
python3 ./.factory/tests/test-runner-install-bootstrap.py
python3 ./.factory/tests/test-runner-installer-security.py
python3 ./.factory/tests/test-broker-security.py
python3 ./.factory/tests/test-dbus-audit.py
python3 ./.factory/tests/test-campaign-residuals.py
python3 ./.factory/tests/test-campaign-archive.py
python3 ./.factory/tests/test-workspace-credentials.py
...
./.factory/tests/test-boilerplate-env-isolation.sh
./.factory/tests/test-production-path-bypass.sh
./.factory/tests/test-conformance.sh
./.factory/tests/test-capability-contracts.sh
./.factory/tests/test-core-acceptance.sh
./.factory/tests/test-audit-receipts.sh
./.factory/tests/test-blocked-facts.sh
./.factory/tests/test-campaign-objectives.sh
./.factory/tests/test-golden-policy.sh
./.factory/tests/test-runner-signer.sh
./.factory/tests/test-boilerplate.sh
./.factory/tests/test-visual-audit.sh
./.factory/tests/test-visual-audit-sdk-authority.sh
./.factory/tests/test-credential-guard.sh
./.factory/tests/test-credential-extension.sh
